...
export default function Portfolio() {
  ...
  return (
    <div
      className="min-h-screen bg-[#0f172a] text-[#94a3b8] font-sans antialiased selection:bg-teal-300 selection:text-teal-900 transition-colors duration-500 relative"
      style={{
        ...
        <div className="lg:flex lg:justify-between lg:gap-4">
          ...
          <main className="pt-24 lg:w-1/2 lg:py-24 flex flex-col gap-24 lg:gap-32">
            ...
            <footer className="max-w-md pb-16 text-xs text-[#64748b] last:mb-0">
              ...
              <p>Designed by Jackson, built with React. All rights reserved.</p>
            </footer>
          </main>
        </div>
      </div>
